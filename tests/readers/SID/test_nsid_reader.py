...
import SciFiReaders
print("SciFiReaders path: ", sys.path, SciFiReaders.__version__)
...
class TestNSIDReader(unittest.TestCase):
    ...
    def test_nsid_bepfm_file(self):
        urllib.request.urlretrieve(r'https://www.dropbox.com/scl/fi/47o3lqye1zip4nsumc2c8/vpfmm_3.hf5?rlkey=y2jel58n9kkl6h3tt2ogq8pqp&dl=1', './vpfm_data.h5')
        ...
        for key in data:
            assert type(data[key])==sidpy.sid.dataset.Dataset, "Expected sidpy dataset but received {}".format(type(data[key]))
